...
export const defaultPresets: Record<string, ThemePreset> = {
  ...
  bejamas: {
    ...
    styles: {
      light: {
        background: "oklch(96.44% .0013 286.38)",
        foreground: "oklch(18.72% .002 286.2)",
        card: "oklch(100% 0 0)",
        "card-foreground": "oklch(18.72% .002 286.2)",
        popover: "oklch(100% 0 0)",
        "popover-foreground": "oklch(18.72% .002 286.2)",
        primary: "oklch(91.98% .1905 128.5)",
        ...
        "muted-foreground": "oklch(50.81% .0143 296.07)",
        accent: "#fff",
        "accent-foreground": "oklch(18.72% .002 286.2)",
        destructive: "#ef4444",
        "destructive-foreground": "#fafafa",
        border: "oklch(91.36% .006 239.83)",
        input: "#e4e4e7",
        ring: "#a1a1aa",
