...
export const themeStylePropsSchema = z.object({
  ...
  footer: z
    .string()
    .describe(
      "The background color for the footer, paired with `footer-foreground`."
    ),
  "footer-foreground": z.string().describe("Paired with `footer`."),
  "footer-primary": z
    .string()
    .describe(
      "The primary color for the footer, paired with `footer-primary-foreground`."
    ),
  "footer-primary-foreground": z
    .string()
    .describe("Paired with `footer-primary`."),
  "footer-border": z
    .string()
    .describe("The color of borders within the footer."),
});
