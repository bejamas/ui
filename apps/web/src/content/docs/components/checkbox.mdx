...
Accessible checkbox with custom styling and indicator.
...
<Label
  class="hover:bg-accent/50 border-border flex items-start gap-3 rounded-lg border p-3 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50 dark:has-[:checked]:border-blue-900 dark:has-[:checked]:bg-blue-950"
>
  <Checkbox
    id="toggle-2"
    defaultChecked
