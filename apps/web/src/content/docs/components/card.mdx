 ...
 *     <p class="text-sm">loves long walks</p>
 *   </Fragment>
 *
 *   <Fragment slot="footer">
 ...
 *       alt="Happy pet"
 *       aria-hidden="true"
 *       src="https://images.unsplash.com/photo-1755899850036-084006cbc1c2?q=80&w=2288&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
 *     />
 *   </Fragment>
 *   <Fragment slot="header">
 *     <h3 class="text-xl font-medium leading-none">Jacky good boi</h3>
...
const cardVariants = cva(
  "text-card-foreground overflow-clip p-5 relative flex flex-col rounded-xl",
  {
    variants: {
      variant: {
...
<div class={cn(cardVariants({ variant, className }))}>
  {
    Astro.slots.media && (
      <div class:list={["z-0", Astro.props.mediaClass]} slot="media">
        <slot name="media" />
      </div>
    )
  }
