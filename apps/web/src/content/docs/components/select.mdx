...
| Prop | Type | Default |
|---|---|---|
| <code>variant</code> | `"default" \| "ghost" \| "neutral"` | `"default"` |
| <code>showCheckmark</code> | `boolean` | `true` |
| <code>options</code> | `Array< string \| { value: string; label?: string; disabled?: boolean } >` | `[]` |
